package cn.qianshu.mybatis.authentication;
...
import cn.qianshu.mybatis.service.VUserDetailsService;
...
public class VAuthenticationProvider implements AuthenticationProvider {  
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {  
        ...
        if(vUserDetails == null){  
        	logger.info("VAuthenticationProvider authenticate user not found!");
